...
function UpdateProfileDialog({ open, setOpen }) {
    ...
    const submitHandler = async (e) =>{
        ...
        try {
            ...
            console.log(error)
            toast.error("Something wint wrong")
            ...
            <Dialog open={open}>
                <DialogContent className="sm:max-w-[425px]" onInteractOutside={() => setOpen(false)}>
                    ...
                    <form onSubmit={submitHandler}>
                        ...
                        <DialogFooter>
                            {
                                loading ? <Button className="w-full my-4"><Loader2 className='mr-2 h-4 w-4 animate-spin' /> Pleas wait</Button> : <Button type="submit" className="w-full my-4">Update</Button>
                            }
